import {BaseHTTPClient, XhrResultParserPriorityType, XhrResponse, XhrError} from '@mydreamplus/aglarond/lib/http';
...
class ApiClient extends BaseHTTPClient {
  constructor() {
    super({
      ...
      resultParserConfig: {
        priorityType: XhrResultParserPriorityType.PhpStyle, // 根据调用的服务情况调整
      },
    });
